...
export const categories = {
    items: 'centers/categories/customer-details',
    vendors: 'centers/categories/vendor-details'
}
export const saps = {
    purchaseOrders: 'centers/saps/po-details',
    purchaseOrderDetail: 'centers/saps/po-detail-items',
    saleOrders: 'centers/saps/so-details',
    saleOrderDetail: 'centers/saps/so-detail-items',
    activities: 'centers/saps/activities-detail',
    opportunity: 'centers/saps/opportunitie-detail',
    opportunityItemDetail: 'centers/saps/activies-opp-item-details'
}
export const hrms = {
    overtime: 'centers/hrm/overtime-details',
    mode: 'centers/hrm/mode-details'
}
export const administrator = {
    user: 'centers/user/logins-details'
}
export const paking = {
    deliveryLine: 'centers/pakage/delivery-line',
    deliveryDetail: 'centers/pakage/delivery-detail'
}
export const journal = {
    incomingDetail: 'centers/journal/incoming-detail'
}
export const plan = {
    planDetail: 'centers/plan/plan-detail'
}
export const issue = {
